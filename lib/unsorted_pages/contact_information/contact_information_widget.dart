...
export 'contact_information_model.dart';
...
class _ContactInformationWidgetState extends State<ContactInformationWidget> {
  late ContactInformationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContactInformationModel());
  }
                  ...
                  children: [
                    ...
                    StreamBuilder<List<SettingsRecord>>(
                      stream: querySettingsRecord(
                        queryBuilder: (settingsRecord) => settingsRecord
                            .where(
                              'type',
                              isEqualTo: 'email',
                            )
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Column(
                          ...
                          children: List.generate(
                              columnSettingsRecordList.length, (columnIndex) {
                            final columnSettingsRecord =
                                columnSettingsRecordList[columnIndex];
                            return InkWell(
                              ...
                              onTap: () async {
                                await launchURL('mailto:secretariat@abac.ph');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                          ...
                          children: List.generate(
                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  await launchURL('wa.me/+639209788404');
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            ...
                                            TextSpan(
                                              text: columnSettingsRecord.value,
                                              style: const TextStyle(
                                                decoration:
